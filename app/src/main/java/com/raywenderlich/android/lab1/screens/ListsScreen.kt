...
private val items = listOf(
    BookCategory(
        R.string.android,
        listOf(
            R.drawable.android_aprentice_,
            R.drawable.saving_data_android_,
            R.drawable.advanced_architecture_android_
        )
    ),
    BookCategory(
        R.string.kotlin,
        listOf(
            R.drawable.kotlin_coroutines_,
            R.drawable.kotlin_aprentice_
        )
    ),
    BookCategory(
        R.string.swift,
        listOf(
            R.drawable.combine_,
            R.drawable.rx_swift_,
            R.drawable.swift_apprentice_,
        )
    ),
    BookCategory(
        R.string.ios,
        listOf(
            R.drawable.core_data_,
            R.drawable.ios_apprentice_,
        )
    )
)

...
fun MyScrollingScreen(modifier: Modifier = Modifier){
    Row(modifier = modifier.horizontalScroll(rememberScrollState())){
        BookImage(R.drawable.advanced_architecture_android_,R.string.android)
        BookImage(R.drawable.kotlin_aprentice_,R.string.kotlin)
        BookImage(R.drawable.kotlin_coroutines_,R.string.kotlin_coroutines)
    }
}
